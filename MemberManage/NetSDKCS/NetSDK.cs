...
{
    /// <summary>
    /// This class is in the SDK network (c + + edition) for c # application development on the basis of the development kit, use this on
    /// contract needs to be original SDK dynamic link library files and the SDK files placed in the same directory
    /// </summary>
    public class Client
    {
        #region << The class definition code>>

        #region << Constant and variable definitions >>

        #region << variable>>

        #region <<  temporary use >>

        ///// <summary>
        ///// **Temporarey**real-time monitoring handle,The next will be integrated into the Channel information
        ///// </summary>
        //private int pRealHandle;
        ///// <summary>
        ///// **Temporarey**network playback handle,The next will be integrated into the Channel information
        ///// </summary>
        ...
        /// <summary>
        /// The mark of initialization operation is completed
        /// </summary>
        private static bool initialized;

        /// <summary>
        /// the private variable of using the SDK version number
        /// </summary>
        private string pSDKVersion;

        /// <summary>
        ///  the private variable of using the equipment user's basic information
        /// </summary>
        private CLIENT_INFO pClientInfo;
        
        /// <summary>
        /// The mark of equipment user login
        /// </summary>
        private bool pLogined=false;

        /// <summary>
        /// The SDK to use the last error message
        /// </summary>
        ...
        /// <summary>
        /// version number of SDK(read- only attribute)
        /// </summary>
        ...
        /// <summary>
        /// Equipment user information(read- only attribute)
        /// </summary>
        ...
        /// <summary>
        /// The mark of equipment user login:true logged in;false Not logged in
        /// </summary>
        public bool Logined
        {
            get
        ...
        /// <summary>
        ///It will Raisie Exceptions When NETSDK is  called fails。
        /// </summary>
        /// <exception cref="Win32Exception">DVR will have a exception when SDK haulage is called failure。</exception>
        private  void ThrowLastError()
        {
            ...
            else
            {
                ...
                pLastError.errMessage = "he recent operation without exception occurs";
            }
        }

        /// <summary>
        /// The error code is converted into standard for text information
        /// </summary>
        ...
        private static string GetLastErrorName(uint errorCode)
        {
            switch (errorCode)
            {
                ...
                case 0x80000000 | 6:
                    return "Colse the channel failure";
                case 0x80000000 | 7:
                    return "The user parameter is illegal";
                case 0x80000000 | 8:
                    return "SDKInitialization error";
                case 0x80000000 | 9:
                    return "SDK clearing error";
                case 0x80000000 | 10:
                    return "apply for render resource error";
                case 0x80000000 | 11:
                    return "The error of Open the decoding library ";
                case 0x800000 | 12:
                    return "The error of coles the decoding library";
                case 0x80000000 | 13:
                ...
                case 0x80000000 | 16:
                    return "the error of sending audio data";
                case 0x80000000 | 17:
                    return "Real-time data is in a state of preservation";
                case 0x80000000 | 18:
                    return "Unsaved real time data";
                case 0x80000000 | 19:
                    return "Error of  Reading Form";
                case 0x80000000 | 20:
                    return "Start the yuntai timer control failure";
                case 0x80000000 | 21:
                    return "the error of  returning the data validation ";
                case 0x80000000 | 22:
                ...
                case 0x80000000 | 29:
                    return "CLientSDK is  uninitialized";
                case 0x80000000 | 30:
                    return "The download has finished";
                case 0x80000000 | 31:
                    return "The query result is empty";
                case 0x80000000 | 32:
                    return "Failed to get the configuration location：system property";
                case 0x80000000 | 33:
                ...
                case 0x80000000 | 35:
                    return "Failed to get the configuration location：DSPcapability description";
                case 0x80000000 | 36:
                    return "Failed to get the configuration location：Network Properties";
                case 0x80000000 | 37:
                    return "Failed to get the configuration location：Channel Names";
                case 0x80000000 | 38:
                    return "Failed to get the configuration location：video attribute";
                case 0x80000000 | 39:
                    return "Failed to get the configuration location：The video timing configuration";
                case 0x80000000 | 40:
                    return "Failed to get the configuration location：Decoder protocol name";
                case 0x80000000 | 41:
                    return "Failed to get the configuration location：232serial port function name";
                case 0x80000000 | 42:
                    return "Failed to get the configuration location：Decoder properties";
                case 0x80000000 | 43:
                    return "Failed to get the configuration location：232serial port attributes";
                case 0x80000000 | 44:
                    return "Failed to get the configuration location：External alarm input attribute";
                case 0x80000000 | 45:
                ...
                case 0x80000000 | 47:
                    return "Failed to get the configuration location：Preview the parameters";
                case 0x80000000 | 48:
                ...
                case 0x80000000 | 55:
                    return "Failed to set the configuration location：General Properties";
                case 0x80000000 | 56:
                    return "Failed to set the configuration location：Network Properties";
                case 0x80000000 | 57:
                    return "Failed to set the configuration location：Channel Names";
                case 0x80000000 | 58:
                    return "Failed to set the configuration location：video attribute";
                case 0x80000000 | 59:
                    return "Failed to set the configuration location：The video timing configuration";
                case 0x80000000 | 60:
                    return "Failed to set the configuration location：Decoder properties";
                case 0x80000000 | 61:
                    return "Failed to set the configuration location：232serial port attributes";
                case 0x80000000 | 62:
                    return "Failed to set the configuration location：External alarm input attribute";
                case 0x80000000 | 63:
                    return "Failed to set the configuration location：Image detection alarm properties";
                case 0x80000000 | 64:
                    return "Failed to set the configuration location：Equipment Time";
                case 0x80000000 | 65:
                    return "Failed to set the configuration location：Preview the parameters";
                case 0x80000000 | 66:
                    return "Failed to set the configuration location：Automatic maintenance configuration";
                case 0x80000000 | 67:
                    return "Failed to set the configuration location：Video matrix configuration";
                case 0x80000000 | 70:
                ...
                case 0x80000000 | 74:
                    return "he server has been started";
                case 0x80000000 | 75:
                    return "The server has not been successful";
                case 0x80000000 | 80:
                ...
                case 0x80000000 | 120:
                    return "Render open audio error";
                case 0x80000000 | 121:
                    return "Render close audio error";
                case 0x80000000 | 122:
                    return "Render Control the volume error";
                case 0x80000000 | 123:
                    return "Render Set the picture parameter error";
                case 0x80000000 | 124:
                    return "Render Pause playback error";
                case 0x80000000 | 125:
                    return "Render Grasp the figure error";
                case 0x80000000 | 126:
                    return "Render Step wrong";
                case 0x80000000 | 127:
                    return "Render Set the frame error rate";
                case 0x80000000 | 999:
                    return "Temporarily can't set";
        ...
        /// <summary>
        /// Initialize the digital video recorder
        /// </summary>
        public  void Init()
        {
        ...
        /// <returns> log in Id,if failed return to 0,otherwise return to Id。</returns>
        ...
        /// Equipment user login
        /// </summary>
        /// <param name="userName">Equipment user name</param>
        /// <param name="userPassword">Equipment user password</param> 
        /// <param name="ip">ip address。</param>
        /// <param name="port">PORT。</param>        
        /// <returns>Log in Id,if failed return to 0,otherwise return to Id。</returns>
        ...
        public bool Login()
        {
            ...
            if (initialized == true && pLogined==false)//Initialize but not logged on
            {
        ...
        /// <summary>
        /// Clean up the SDK environment, when the program before the end of the execution。
        /// </summary>
        public void Cleanup()
        {
            CLIENT_Cleanup();
        ...
        /// <summary>
        /// Real-time monitoring began
        /// </summary>
        /// <param name="intChannelID">channel ID</param>
        /// <param name="hWnd">Play the container handles</param>
        /// <returns></returns>
        public int RealPlay(int intChannelID, IntPtr hWnd)
        {
            ...
            else
            {
                ...
                ThrowLastError();
                pClientInfo.Channel[intChannelID].RealPlayHandle = returnValue;//retain handle
            }
            if (returnValue != 0)
            {
        ...
        /// <summary>
        /// The end of the real-time monitoring
        /// </summary>
        /// <param name="intChannelID">Channel ID</param>
        ...
        public bool StopRealPlay(int intChannelID)
        {
            ...
            if (pLogined == true)//Determine whether the login
            {
                //returnValue = CLIENT_StopRealPlay(pRealHandle);//**temporary**Handle real-time monitoring,Behind will be integrated into the Channel information	
                if (pClientInfo.DeviceChannelCount >= intChannelID + 1)//Identifying the effective channel
                {
                    if (pClientInfo.Channel[intChannelID].blnRealPlay == true)//Determine whether the channel real-time monitoring
                    {
        ...
        #region << The original SDK (c + + version) the calling code >>
        ...
        #region << Real-time monitoring interface >>

        /// <summary>
        /// Start the real-time monitoring
        /// </summary>
        /// <param name="lLoginID">Equipment user login handle</param>
        /// <param name="nChannelID">channel ID</param>
        /// <param name="hWnd">Monitor container to handle</param>
        /// <returns>Failure to return0,Successful return to the real-time monitoring ID(Handle real-time monitoring),Will serve as the parameters of the correlation function</returns>
        [DllImport("dhnetsdk.dll")]
        ...
        /// </summary>
        /// <param name="lRealHandle">Handle real-time monitoring</param>
        /// <returns>successful return TRUE,Failure to return FALSE</returns>
        [DllImport("dhnetsdk.dll")]
        ...
        #region << Playback and download interface >>
        ...
        /// <param name="tmEnd">The video end time</param>
        /// <param name="pchCardid">card ID.,Only for card number query effective, other cases can be NULL</param>
        /// <param name="nriFileinfo">Return to video file information,An array is a net RECORDFILE INFO structure</param>
        /// <param name="maxlen">nriFileinfo The maximum length of the buffer;（Unit of byte,suggest between  100-200*sizeof(NET_RECORDFILE_INFO)）</param>
        /// <param name="filecount">Returns the number of file,Belongs to output parameters refer only to the biggest buffer full video record</param>
        /// <param name="waittime">waittime</param>
        /// <param name="bTime">Whether by time(The invalid)</param>
        /// <returns>succeed to return TRUE,fail t reurn FALSE</returns>
        [DllImport("dhnetsdk.dll")]
        ...
        /// <summary>
        /// Network playback[Note: after a user logs in a device, each channel at the same time can only play a video, can't play the same channel multiple records at the same time]
        /// </summary>
        /// <param name="lLoginID">Equipment user login handle</param>
        /// <param name="lpRecordFile">Video file information, when the press time play is only need to fill the start time and end time, and other items to fill 0</param>
        /// <param name="hWnd">Playback handle container</param>
        /// <param name="cbDownLoadPos">Progress of the callback function</param>
        /// <param name="dwUserData">SYSNAME</param>
        /// <returns>Successful return to network playback ID, failure returns 0</returns>
        ...
        /// <param name="lLoginID">Device handle user login</param>
        /// <param name="nChannelID">channel ID</param>
        /// <param name="lpStartTime">The video start time</param>
        /// <param name="lpStopTime">The video end time</param>
        /// <param name="hWnd">Video playback handle container</param>
        /// <param name="cbDownLoadPos">Progress of the callback function</param>
        /// <param name="dwUserData">SYSNAME</param>
        /// <returns>Successful return to network playback ID, failure returns 0</returns>
        [DllImport("dhnetsdk.dll")]
        ...
        /// </summary>
        /// <param name="lPlayHandle">palyback handle</param>
        ...
        /// <param name="bPause">1:pause;0:resume</param>
        /// <returns>Returns TRUE on success and FALSE on failure</returns>
        [DllImport("dhnetsdk.dll")]
        private static extern bool CLIENT_PausePlayBack(int lPlayHandle, int bPause);

        /// <summary>
        /// Change position [i.e. drag play, only opened the image hWnd effectively the function parameters of the function to obtain the parameters of the is valid, otherwise meaningless]
        /// </summary>
        /// <param name="lPlayHandle">play handle </param>
        /// <param name="offsettime">Relative files start migration time, the unit is in seconds. When its value is 0 XFFFFFFFF, this parameter is invalid.</param>
        /// <param name="offsetbyte">Relative file start offset bytes, when its value is 0 XFFFFFFFF, this parameter is invalid; When offsettime effectively, this parameter is meaningless</param>
        /// <returns>Returns TRUE on success and FALSE on failure</returns>
        [DllImport("dhnetsdk.dll")]
    ...
    public struct DEVCHANNEL_INFO
    {
        ...
        /// <summary>
        /// Channel playback symbol
        /// </summary>
        public bool blnPlayBack;
        /// <summary>
        ///channel playback handle
        /// </summary>
    ...
    public struct NET_DEVICEINFO
    {
        ...
        public byte byAlarmInPortNum; //DVR Alarm input number
        public byte byAlarmOutPortNum; //DVR Alarm output number
        public byte byDiskNum; //DVR HDD number
    ...
    public enum PlayCon
    {
        ...
        Stop,
        /// <summary>
        /// Drag the playback[According to the time migration]
        /// </summary>
        SeekByTime,
        /// <summary>
        /// Drag the playback[According to the byte offset]
        /// </summary>
        SeekByBit,
        /// <summary>
        /// Single step broadcast began[Call a frame at a time]
        /// </summary>
        StepPlay,
        /// <summary>
        /// One step to stop
    ...
    {        
        ...
        /// <summary>
        /// Training in rotation between points
        /// </summary>
        ...
        PTZ_LAMP_CONTROL,
        /// <summary>
        /// upleft:p1 horizontal velocity, p2 vertical velocity
        /// </summary>
        EXTPTZ_LEFTTOP = 0X20,
        /// <summary>
        /// upright:p1 horizontal velocity, p2 vertical velocity
        /// </summary>
        EXTPTZ_RIGHTTOP,
        /// <summary>
        ///  left bottom:p1 horizontal velocity, p2 vertical velocity
        /// </summary>
        EXTPTZ_LEFTDOWN,
        /// <summary>
        ///  right bottom:p1 horizontal velocity, p2 vertical velocity
        /// </summary>
        EXTPTZ_RIGHTDOWN,
        /// <summary>
        /// Join the preset points to the cruise:p1 Cruise lines	p2 Preset point
        /// </summary>
        EXTPTZ_ADDTOLOOP,
        /// <summary>
        /// Delete the preset point in cruise:p1 Cruise lines	p2 Preset point
        /// </summary>
        EXTPTZ_DELFROMLOOP, 
        /// <summary>
        /// Remove the cruise:p1Cruise lines	
        /// </summary>
        EXTPTZ_CLOSELOOP,
        /// <summary>
        /// Began to rotate
        ...
        /// <summary>
        /// start the  mode:Line Mode
        /// </summary>
        EXTPTZ_SETMODESTART,
        /// <summary>
        /// end the  mode:Line Mode
        /// </summary>
        EXTPTZ_SETMODESTOP,
		/// <summary>
        /// Operation mode: p1 model line
		/// </summary>		
        EXTPTZ_RUNMODE,
        /// <summary>
        ///stop mode: p1 model line
        /// </summary>
        EXTPTZ_STOPMODE,
        /// <summary>
        /// clear  mode: p1 model line
        /// </summary>
        EXTPTZ_DELETEMODE,
        /// <summary>
        /// Flip command
        ...
        EXTPTZ_REVERSECOMM,
        /// <summary>
        /// Rapid vertical coordinate positioning coordinates p1 level p2 p3 changing times	 p3zoom
        /// </summary>
        EXTPTZ_FASTGOTO,
        /// <summary>
        /// x34:Auxiliary switch to open	 p1auxiliary point		
        /// </summary>
        EXTPTZ_AUXIOPEN,
        /// <summary>
        /// 0x35:Auxiliary switch to close	p1auxiliary point
        /// </summary>
        EXTPTZ_AUXICLOSE,
        /// <summary>
        /// Open the ball machine menu
        /// </summary>
...
namespace NetSDK
{
    ...
    public sealed class NETClient
    {
        ...
        public static int NETStartService(ushort wPort, string pIp, fServiceCallBack pfscb, IntPtr dwTimeOut, IntPtr dwUserData)
        {
            int returnValue;
